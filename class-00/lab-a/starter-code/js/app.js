...
function displayPics(){
  ...
  // Changing 'rando' from a local scoped variable to block scoped variable. So now instead of being able to access it from within the function (local scope) we can only access it from the block scope (within those curly braces). If we want to console log rando we just need to move the command to line 33.
  console.log(viewed);
